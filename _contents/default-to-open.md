...
* Open civic organizations, GovFresh[2](/references#reference-2)  
* Default to open, U.S. Digital Services Playbook[3](/references#reference-3)  
* The Open Organization: Igniting Passion and Performance, Jim Whitehurst[4](/references#reference-4)  
* Open Government Directive, The White House[5](/references#reference-5)  
* Make things open: it makes things better, GOV.UK[6](/references#reference-6)  
* The Open Organization Maturity Model, Opensource.com[7](/references#reference-7)
